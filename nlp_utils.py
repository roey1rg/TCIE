...
def get_animals_data_df(data_path=None, limit_per_class=10):
    data_path = data_path or '/home/dcor/roeyron/interpretability_multi_hop/patchscopes/code/nlp_project/animals10/raw-img/',
    translate = {'cane': 'dog', 'cavallo': 'horse', 'elefante': 'elephant','farfalla': 'butterfly','gallina': 'hen','gatto': 'cat','mucca': 'cow', 'pecora': 'sheep','ragno': 'spider','scoiattolo': 'squirrel'}
...
def get_celeba_data_df(data_path=None, limit=200):
    ...
    df['image_path'] = df.image_id.apply(lambda image_id: os.path.join(dataset_path, 'img_align_celeba/img_align_celeba/', image_id))
